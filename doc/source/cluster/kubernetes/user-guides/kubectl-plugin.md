...
Users can submit a RayJob without specifying a yaml, the command generates a RayJob based on the following:
...
Users can add the following yaml file `ray-job.interactivemode.yaml`
